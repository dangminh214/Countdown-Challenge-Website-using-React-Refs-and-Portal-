...
### Update 2: Add Result and Countdown components, forward a ref from a component to other component with forwardRef function, show dialog using dialog Element and React 
